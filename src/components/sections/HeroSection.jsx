...
const HeroSection = () => {
  // Dynamic chart data
  const chartData = [
    { label: 'Wins', percentage: 78, color: '#9333EA', value: 23 },
    { label: 'Draws', percentage: 12, color: '#F97316', value: 5 },
    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Left Panel - Image with UI Elements */}
          <motion.div
          ...
          >
            <div className="relative bg-gradient-to-br from-purple-50 via-purple-100 to-purple-50 rounded-2xl p-4 md:p-6 overflow-hidden min-h-[500px] md:min-h-[550px] flex items-center">
              ...
              <div className="relative z-10 w-full h-full flex items-center">
                <div className="relative">
                  <img
                    src="/aboutgirl.png"
                    alt="Student"
                    className="w-full h-auto max-w-[280px] md:max-w-[320px] object-contain relative z-10"
                  />
                  ...
                  <motion.div
                    ...
                    className="absolute -top-4 -left-4 md:-top-6 md:-left-6 bg-gradient-to-r from-pink-200 to-red-200 rounded-xl p-3 md:p-4 shadow-xl z-20"
                  ...
                  >
                    <h4 className="text-sm md:text-base font-semibold text-gray-900 mb-3 text-center">
                      Global Statistic
                    </h4>
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white rounded-xl p-2 md:p-3 shadow-xl z-20"
                    style={{ minWidth: '200px', maxWidth: '220px' }}
                  >
                    <ScoreListCard data={scoreData} />
                  </motion.div>
                </div>
              </div>
            </div>
